...
namespace PRN232_SU25_SE182614_Repository.Basic
{
    public class GenericRepository<T> where T : class
    {
        protected SmartphoneDbContext _context;

        public GenericRepository()
        {
            _context ??= new SmartphoneDbContext();
        }

        public GenericRepository(SmartphoneDbContext context)
        {
            _context = context;
        }
